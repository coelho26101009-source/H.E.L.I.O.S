    ...
    <div className="relative flex items-center justify-center w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96">
      ...
      {isActive && stars.map((_, index) => {
        ...
        return (
          ...
          >
            {/* A Estrela em si (o ponto brilhante) */}
            <div 
      ...
      <div 
        ...
        style={{
          // Brilho externo reage ao volume se estiver a falar
          boxShadow: isActive ? `0 0 50px rgba(245, 158, 11, ${isSpeaking ? 0.4 : 0.1})` : 'none',
          transform: `scale(${pulseScale + (volume / 400)})` // Pulsa com o volume
        }}
      >
        {/* Gradiente Interno e Pulsação */}
        <div 
      ...
      {/* "The Guardian" - O ponto único que roda sempre */}
      {isActive && (
